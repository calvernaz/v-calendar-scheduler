            ...
            <div class="v-cal-header__actions">
                ...
                <div class="actions-right">
                    <button class="v-cal-button" v-for="view in availableViews" @click="switchView(view)"
                            :class="{ 'v-cal-button--is-active': activeView === view }">{{ labels[view] |
    ...
    export default {
        ...
        methods: {
            openEventDialog(date) {
                if (!this.disableDialog) {
                    ...
                    if (date instanceof Date) {
                        ...
                        config.startTime = date.time !== null ? moment(date.time, 'HH') : null;
                        config.endTime = date.time !== null ? moment(date.time, 'HH').add(1, 'h') : null;
                    }
            ...
            bindEvents() {
                ...
                EventBus.$on('time-clicked', (date) => {
                    this.$emit('time-clicked', date);
                    this.openEventDialog(date);
                });
